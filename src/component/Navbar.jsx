...
const Navbar = () => {
    ...
    return (
        <nav className={`${styles.paddingX} w-full items-center
        py-5 fixed  top-0 z-20 bg-primary`}>
            <div className="w-full flex justify-between items-center  max-w-7xl mx-auto">
                <Link to="/" className="flex items-center gap=2" onClick={() => {
                    ...
                    <p className="text-white text-[18px] font-bold cursor-pointer flex">Sutton
                        &nbsp; <span
                        className="sm:block hidden">| Javascript </span></p>
                </Link>
                ...
                */}
                ...
                <div className={`${!toggle ? 'hidden' : 'flex'}
                    p-6 accent-green-300 absolute  top-20 right-0
